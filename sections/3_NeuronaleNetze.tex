...
Die Berechnung der Korrellationsmatrix funktioniert folgendermassen:

\begin{itemize}
	\item Alle Muster definieren $x_1 = \left[-1 1 1 1\right]; x_2 =  [1 1 1 -1]$
	\item Energiematrix aus Korrelationsmatrizen erstellen $M = x_1' x_1 + x_2' x_2$
	\item $M_{i,i} = 0$
\end{itemize}
